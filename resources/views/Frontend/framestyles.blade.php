...
@push('page-styles')
    ...
    <link rel="stylesheet" href="{{asset('assets/frontend')}}/css/frame-styles.css" media="screen,print" />
@endpush
                            ...
                            <div class="col-md-9 text-center">
                                <ul id="frame-styles-sort">
                                    <li class="metal gold black white silver color shiny matte dark light flat modern thin">
                                        <a href="">
                                            <img data-sizes="auto" src="{{asset('assets/frontend')}}/images/cart/profiles/frame-1.jpg" class="lazyload" />
                                            <h4>Frame-1</h4>
                                        </a>
                                    </li>
                                    <li class="metal black silver shiny matte dark light flat modern thick">
                                        <a href="frame-styles/bradford.html">
                                            <img data-sizes="auto" src="{{asset('assets/frontend')}}/images/cart/profiles/frame-2.jpg" class="lazyload" />
                                            <h4>Frame-2</h4>
                                        </a>
                                    </li>
                                    <li class="wood wood-natural black white gold dark light wood-colored flat rustic thick">
                                        <a href="frame-styles/dayton.html">
                                            <img data-sizes="auto" src="{{asset('assets/frontend')}}/images/cart/profiles/frame-3.jpg" class="lazyload" />
                                            <h4>Frame-3</h4>
                                        </a>
                                    </li>
                                    <li class="wood black white dark light wood-colored flat rustic thick">
                                        <a href="frame-styles/derby.html">
                                            <img data-sizes="auto" src="{{asset('assets/frontend')}}/images/cart/profiles/frame-4.jpg" class="lazyload" />
                                            <h4>Frame-4</h4>
                                        </a>
                                    </li>
                                    <li class="metal gold black white silver color shiny matte dark light flat modern thin">
...
<script type="text/javascript" src="{{asset('assets/frontend')}}/js/frame-styles.js"></script>
