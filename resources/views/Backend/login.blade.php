...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/png" sizes="16x16" href="{{asset('assets/backend')}}/demo/favicon.png" />
        <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
        <title>Kornizesbadra.com</title>
        <!-- CSS -->
        <link href="https://fonts.googleapis.com/css?family=Poppins:200,300,400,500,600" rel="stylesheet" type="text/css" />
        <link href="{{asset('assets/backend')}}/vendors/material-icons/material-icons.css" rel="stylesheet" type="text/css" />
        <link href="{{asset('assets/backend')}}/vendors/mono-social-icons/monosocialiconsfont.css" rel="stylesheet" type="text/css" />
        <link href="{{asset('assets/backend')}}/vendors/feather-icons/feather.css" rel="stylesheet" type="text/css" />
    ...
    <body class="body-bg-full profile-page" style="background-image: url({{asset('assets/backend')}}/img/site-bg.jpg);">
        <div id="wrapper" class="row wrapper">
            <div class="container-min-full-height d-flex justify-content-center align-items-center">
                <div class="login-center">
                    <div class="navbar-header text-center mt-2 mb-4">
                        <img alt="" src="{{asset('assets/backend')}}/img/logo-dark.png" />
                    </div>
                    ...
                    <form method="post" action="{{ route('login.submit') }}">
                        ...
                        <div class="form-group no-gutters mb-0">
                            <div class="col-md-12 d-flex">
                                ...
                                <a href="{{route('forgetpassword')}}" id="to-recover" class="my-auto pb-2 text-right"><i class="material-icons mr-2 fs-18">lock</i> Forgot Password?</a>
                            </div>
                            <!-- /.col-md-12 -->
                        </div>
                        <!-- /.form-group -->
        ...
        <script src="{{asset('assets/backend')}}/js/material-design.js"></script>
    </body>
</html>
