                        ...
                        <div class="col-md-12 widget-holder">
                            <div class="widget-bg">
                                <div class="widget-body clearfix">
                                    ...
                                    <form action="@if($data){{route('material.update',['material'=>$data->id])}}@else{{route('material.store')}}@endif" method="post" id="Material-Form">
                                        @csrf
                                        ...
                                        <div class="form-actions">
                                            <div class="form-group row">
                                                <div class="col-md-9 ml-md-auto btn-list">
                                                    ...
                                                    <a class="btn btn-outline-default" type="button" href="{{route('material.index')}}">Cancel</a>
                                                </div>
                                            </div>
                                        </div>
