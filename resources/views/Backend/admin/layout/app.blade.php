...
<html lang="en" class="no-js">
    <head>
        ...
        <link rel="stylesheet" href="{{asset('assets/backend')}}/css/pace.css">
        ...
        <script data-pace-options='{ "ajax": false, "selectors": [ "img" ]}' src="{{asset('assets/backend')}}/js/pace.min.js"></script>
    </head>
    
    <body class="sidebar-light sidebar-expand navbar-brand-dark">
        <div id="wrapper" class="wrapper">
            @include('Backend.admin.layout.includes.header')
            <div class="content-wrapper">
                @include('Backend.admin.layout.includes.sidebar')
                
                @yield('main-content')
            </div>
            <!-- /.content-wrapper -->
            @include('Backend.admin.layout.includes.footer')
        </div>
        <!--/ #wrapper -->
        <!-- Scripts -->
        <style>
