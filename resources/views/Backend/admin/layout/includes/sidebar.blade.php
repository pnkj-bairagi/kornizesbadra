...
<aside class="site-sidebar scrollbar-enabled" data-suppress-scroll-x="true">
    <nav class="sidebar-nav">
        <ul class="nav in side-menu">
            <li class="">
                <a href="{{route('dashboard')}}"><i class="list-icon material-icons">home</i> <span class="hide-menu">Dashboard</span></a>
            </li>
            ...
            <li class="">
                <a href="{{route('users')}}"><i class="list-icon feather feather-user"></i> <span class="hide-menu">Users</span></a>
            </li>
            <li class="">
                <a href="reviews.html">
            ...
            <li class="menu-item-has-children">
                ...
                <ul class="list-unstyled sub-menu">
                    ...
                    <li><a href="{{route('thickness.index')}}">Thickness</a></li>
            ...
            <li class="">
                <a href="{{route('profile')}}"><i class="list-icon feather feather-feather"></i> <span class="hide-menu">Profile</span></a>
            </li>
            <li class="">
                <a href="{{route('setting')}}"><i class="list-icon feather feather-settings"></i> <span class="hide-menu">Settings</span></a>
            </li>
            <li class="">
                <a href="screenunlock.html"><i class="list-icon feather feather-lock"></i> <span class="hide-menu">Screen Lock</span></a>
            </li>
            <li class="">
                <a href="{{route('adminlogout')}}"><i class="list-icon feather feather-power"></i> <span class="hide-menu">Logout</span></a>
            </li>
        </ul>
        <!-- /.side-menu -->
    </nav>
