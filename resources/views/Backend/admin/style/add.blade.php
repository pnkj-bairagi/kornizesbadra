                        ...
                        <div class="col-md-12 widget-holder">
                            <div class="widget-bg">
                                <div class="widget-body clearfix">
                                    ...
                                    <form action="@if($data){{route('style.update',['style'=>$data->id])}}@else{{route('style.store')}}@endif" method="post" id="Style-Form">
                                        @csrf
                                        ...
                                        <div class="form-actions">
                                            <div class="form-group row">
                                                <div class="col-md-9 ml-md-auto btn-list">
                                                    ...
                                                    <a class="btn btn-outline-default" type="button" href="{{route('style.index')}}">Cancel</a>
                                                </div>
                                            </div>
                                        </div>
