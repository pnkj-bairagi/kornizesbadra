                            ...
                            <div class="widget-body clearfix">
                                <form>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" id="l0" placeholder="" value="#{{Auth::user()->id}}" type="text" />
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label" for="l10">Name</label>
                                        <div class="col-md-9">
                                            <input class="form-control" id="l10" placeholder="" value="{{Auth::user()->name}}" type="text" />
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group">
                                                ...
                                                <!-- /.input-group-prepend -->
                                                <input class="form-control" id="l2" placeholder="Email Address" value="{{Auth::user()->email}}" type="email" />
                                            </div>
                                            <!-- /.input-group -->
                                        </div>
                                        <!-- /.col-md-9 -->
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group">
                                                ...
                                                <!-- /.input-group-append -->
                                                <input class="form-control" id="l3" placeholder="Password" value="{{Auth::user()->plain_password}}" type="password" />
                                            </div>
                                            <!-- /.input-group -->
                                        </div>
                                        <!-- /.col-md-9 -->
