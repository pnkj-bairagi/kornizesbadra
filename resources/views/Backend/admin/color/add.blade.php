                        ...
                        <div class="col-md-12 widget-holder">
                            <div class="widget-bg">
                                <div class="widget-body clearfix">
                                    ...
                                    <form action="@if($data){{route('color.update',['color'=>$data->id])}}@else{{route('color.store')}}@endif" method="post" id="Color-Form">
                                        @csrf
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                 <input class="form-control" id="color" placeholder="Select Color" name="color_code" type="color" value="@if($data){{$data->color_code}}@endif">
                                            </div>
                                        </div>
                                        <div class="container-fluid">
                                        <div class="form-actions">
                                            <div class="form-group row">
                                                <div class="col-md-9 ml-md-auto btn-list">
                                                    ...
                                                    <a class="btn btn-outline-default" type="button" href="{{route('color.index')}}">Cancel</a>
                                                </div>
                                            </div>
                                        </div>
