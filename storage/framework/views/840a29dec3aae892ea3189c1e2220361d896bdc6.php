...
<?php $__env->startSection('main-content'); ?>
    <main id="site-main">
        <div class="page-wrapper">
            <div id="home-hero">
                <div class="hero-wrapper" style="background-image: url('<?php echo e(asset('assets/frontend')); ?>/images/template/banners/banner1.png');">
                ...
                <div id="home-content" class="page-slice">
                    <div id="design-your-frame" class="content-slice">
                        ...
                        <div id="the-frame-builder" class="row">
                                                ...
                                                <div class="profile-wrap">
                                                    <div class="profile-box active" data-profile-materials="Wood" data-profile-id="7" data-color-id="12">
                                                        <div class="profile-select-container">
                                                            ...
                                                            <div class="profile-image-sub-container">
                                                                <div class="profile-image profile-7-image" style="background-image:url('<?php echo e(asset('assets/frontend')); ?>/images/cart/profiles/frame-1.jpg?r=478');"></div>
                                                            </div>
                                                            <div class="profile-details-wrapper">
                                                                ...
                                                                <div class="profile-color-list">
                                                                    ...
                                                                    <div class="color-choice-container">
                                                                        <div
                                                                            style="background-image: url('<?php echo e(asset('assets/frontend')); ?>/images/template/profile_colors/black_grain.png')"
                                                                            alt="Black Grain"
                                                                            class="color-choice color-tooltip"
                                                                    ...
                                                                    <div class="color-choice-container">
                                                                        <div
                                                                            style="background-image: url('<?php echo e(asset('assets/frontend')); ?>/images/template/profile_colors/rustic_gray.png')"
                                                                            alt="Rustic Gray"
                                                                            class="color-choice color-tooltip"
                                                                    ...
                                                                    <div class="color-choice-container">
                                                                        <div
                                                                            style="background-image: url('<?php echo e(asset('assets/frontend')); ?>/images/template/profile_colors/wheat.png')"
                                                                            alt="Wheat"
                                                                            class="color-choice color-tooltip"
                                                                    ...
                                                                    <div class="color-choice-container">
                                                                        <div
                                                                            style="background-image: url('<?php echo e(asset('assets/frontend')); ?>/images/template/profile_colors/hazel.png')"
                                                                            alt="Hazel"
                                                                            class="color-choice color-tooltip"
                                                                    ...
                                                                    <div class="color-choice-container">
                                                                        <div
                                                                            style="background-image: url('<?php echo e(asset('assets/frontend')); ?>/images/template/profile_colors/russet.png')"
                                                                            alt="Russet"
                                                                            class="color-choice color-tooltip"
                                                    ...
                                                    <div class="profile-box" data-profile-materials="Wood" data-profile-id="11" data-color-id="12">
                                                        <div class="profile-select-container">
                                                            ...
                                                            <div class="profile-image-sub-container">
                                                                <div class="profile-image profile-11-image" style="background-image:url('<?php echo e(asset('assets/frontend')); ?>/images/cart/profiles/frame-2.jpg?r=478');"></div>
                                                            ...
                                                            <div class="profile-details-wrapper">
                                                                ...
                                                                <div class="profile-color-list">
                                                                    ...
                                                                    <div class="color-choice-container">
                                                                        <div
                                                                            style="background-image: url('<?php echo e(asset('assets/frontend')); ?>/images/template/profile_colors/cocoa.png')"
                                                                            alt="Cocoa"
                                                                            class="color-choice color-tooltip"
                                                                    ...
                                                                    <div class="color-choice-container">
                                                                        <div
                                                                            style="background-image: url('<?php echo e(asset('assets/frontend')); ?>/images/template/profile_colors/umber.png')"
                                                                            alt="Umber"
                                                                            class="color-choice color-tooltip"
                                                                    ...
                                                                    <div class="color-choice-container">
                                                                        <div
                                                                            style="background-image: url('<?php echo e(asset('assets/frontend')); ?>/images/template/profile_colors/sand.png')"
                                                                            alt="Sand"
                                                                            class="color-choice color-tooltip"
                                                    ...
                                                    <div class="profile-box" data-profile-materials="Wood" data-profile-id="10" data-color-id="12">
                                                        <div class="profile-select-container">
                                                            ...
                                                            <div class="profile-image-sub-container">
                                                                <div class="profile-image profile-10-image" style="background-image:url('<?php echo e(asset('assets/frontend')); ?>/images/cart/profiles/frame-3.jpg?r=478');"></div>
                                                                <div class="profile-image-zoom-in" role="button" data-toggle="modal" data-target="#frame-preview-modal" data-sku="" data-image="" data-profile-id="" data-color-id="21">
                                                                    <i class="fas fa-search-plus" title="Zoom in"></i>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="profile-box" data-profile-materials="Metal" data-profile-id="1" data-color-id="12">
                                                        <div class="profile-select-container">
                                                            ...
                                                            <div class="profile-image-sub-container">
                                                                <div class="profile-image profile-1-image" style="background-image:url('<?php echo e(asset('assets/frontend')); ?>/images/cart/profiles/frame-4.jpg?r=478');"></div>
                                                                <div class="profile-image-zoom-in" role="button" data-toggle="modal" data-target="#frame-preview-modal" data-sku="" data-image="" data-profile-id="" data-color-id="21">
                                                                    <i class="fas fa-search-plus" title="Zoom in"></i>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="profile-box" data-profile-materials="Metal" data-profile-id="3" data-color-id="12">
                                                        <div class="profile-select-container">
                                                            ...
                                                            <div class="profile-image-sub-container">
                                                                <div class="profile-image profile-3-image" style="background-image:url('<?php echo e(asset('assets/frontend')); ?>/images/cart/profiles/frame-1.jpg?r=478');"></div>
                                                                <div class="profile-image-zoom-in" role="button" data-toggle="modal" data-target="#frame-preview-modal" data-sku="" data-image="" data-profile-id="" data-color-id="21">
                                                                    <i class="fas fa-search-plus" title="Zoom in"></i>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="profile-box" data-profile-materials="Metal" data-profile-id="2" data-color-id="12">
                                                        <div class="profile-select-container">
                                                            ...
                                                            <div class="profile-image-sub-container">
                                                                <div class="profile-image profile-2-image" style="background-image:url('<?php echo e(asset('assets/frontend')); ?>/images/cart/profiles/frame-2.jpg?r=478');"></div>
                                                                <div class="profile-image-zoom-in" role="button" data-toggle="modal" data-target="#frame-preview-modal" data-sku="" data-image="" data-profile-id="" data-color-id="21">
                                                                    <i class="fas fa-search-plus" title="Zoom in"></i>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="profile-box" data-profile-materials="Metal" data-profile-id="4" data-color-id="12">
                                                        <div class="profile-select-container">
                                                            ...
                                                            <div class="profile-image-sub-container">
                                                                <div class="profile-image profile-4-image" style="background-image:url('<?php echo e(asset('assets/frontend')); ?>/images/cart/profiles/frame-3.jpg?r=478');"></div>
                                                                <div class="profile-image-zoom-in" role="button" data-toggle="modal" data-target="#frame-preview-modal" data-sku="" data-image="" data-profile-id="" data-color-id="21">
                                                                    <i class="fas fa-search-plus" title="Zoom in"></i>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="profile-box" data-profile-materials="Metal" data-profile-id="5" data-color-id="12">
                                                        <div class="profile-select-container">
                                                            ...
                                                            <div class="profile-image-sub-container">
                                                                <div class="profile-image profile-5-image" style="background-image:url('<?php echo e(asset('assets/frontend')); ?>/images/cart/profiles/frame-4.jpg?r=478');"></div>
                                                                <div class="profile-image-zoom-in" role="button" data-toggle="modal" data-target="#frame-preview-modal" data-sku="" data-image="" data-profile-id="" data-color-id="21">
                                                                    <i class="fas fa-search-plus" title="Zoom in"></i>
                                                                </div>
                                                            </div>
                                            ...
                                            <div id="matting-group" class="tab-content" data-tab-id="3" data-tab-name="matting">
                                                <p style="font-size: 15px;">
                                                    ...
                                                    <span
                                                        ...
                                                        data-trigger="hover"
                                                        data-placement="top"
                                                        data-content="<img data-src='<?php echo e(asset('assets/frontend')); ?>/images/template/how-matting-works.jpg' alt='How Matting Works'></p><p>Matting goes around the artwork. The yellow area is where the mat overlaps the artwork by 1/4&quot; on each side.</p><p>Questions? Contact us - we'll help!</p>"
                                                    >
                                                ...
                                                <div class="matting-group-wrapper">
                                                    <div class="selection-tile active" data-mat-quantity="0">
                                                        <div class="matting-options-wrapper">
                                                            <div class="image no-mat">
                                                                <img data-src="<?php echo e(asset('assets/frontend')); ?>/images/template/matboards/no-mat.jpg" width="140" height="140" alt="No Mat" />
                                                            </div>
                                                            <div class="description">
                                                    ...
                                                    <div class="selection-tile" data-mat-quantity="1">
                                                        <div class="selection-tile-content">
                                                            <div class="matting-options-wrapper">
                                                                <div class="image">
                                                                    <img data-src="<?php echo e(asset('assets/frontend')); ?>/images/template/matboards/single-mat.jpg" width="140" height="140" alt="Single Mat" />
                                                                </div>
                                                                <div class="description">
                                                    ...
                                                    <div class="selection-tile" data-mat-quantity="2">
                                                        <div class="matting-options-wrapper">
                                                            <div class="image">
                                                                <img data-src="<?php echo e(asset('assets/frontend')); ?>/images/template/matboards/double-mat.jpg" width="140" height="140" alt="Double Mat" />
                                                            </div>
                                                            <div class="description">
                                                ...
                                                <div class="cover-group-wrapper">
                                                    <div class="selection-tile active" data-cover-id="3" data-alt-cover-id="3">
                                                        <div class="cover-options-wrapper">
                                                            <div class="image">
                                                                <img data-src="<?php echo e(asset('assets/frontend')); ?>/images/template/covers/clear-acrylic-small.jpg" width="140" height="140" alt="Clear Acrylic" />
                                                            </div>
                                                            <div class="description">
                                                    ...
                                                    <div class="selection-tile" data-cover-id="5" data-alt-cover-id="5">
                                                        <div class="cover-options-wrapper">
                                                            <div class="image">
                                                                <img data-src="<?php echo e(asset('assets/frontend')); ?>/images/template/covers/non-glare-acrylic-small.jpg" width="140" height="140" alt="Non-Glare Acrylic" />
                                                            </div>
                                                            <div class="description">
                            ...
                            <div class="col-xs-5">
                                <!-- Frame Preview -->
                                <div class="frame-preview-notification-wrapper" style="background-image: url('<?php echo e(asset('assets/frontend')); ?>/images/template/framepreview.png'); ">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <a href="everything-to-know-picture-frames-online.html">
                                    <img data-sizes="auto" src="<?php echo e(asset('assets/frontend')); ?>/images/template/preview.jpg" alt="Variety of custom frame options" class="main-frame lazyload" />
                                </a>
                            </div>
                            <div class="col-md-6">
                                <a href="guide.html">
                            ...
                            <div class="modal-content">
                                <div class="modal-body">
                                    ...
                                    <div id="additional-hardware" class="section row hide">
                                        ...
                                        <div class="col-md-3">
                                            <img data-sizes="auto" data-src="<?php echo e(asset('assets/frontend')); ?>/images/cart/accessories/85.jpg" class="hardware-thumbnail lazyload" alt="Metal Frame Secure Hanging Hardware" />
                                        </div>
                                        <div class="col-md-9">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('Frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/iweblhrx/public_html/kornizesbadra/resources/views/Frontend/home.blade.php ENDPATH**/ ?>