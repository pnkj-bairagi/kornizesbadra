                        ...
                        <div class="col-md-12 widget-holder">
                            <div class="widget-bg">
                                <div class="widget-body clearfix">
                                    ...
                                    <form action="<?php if($data): ?><?php echo e(route('thickness.update',['thickness'=>$data->id])); ?><?php else: ?><?php echo e(route('thickness.store')); ?><?php endif; ?>" method="post" id="thickness-Form">
                                        <?php echo csrf_field(); ?>
                                        ...
                                        <div class="form-actions">
                                            <div class="form-group row">
                                                <div class="col-md-9 ml-md-auto btn-list">
                                                    ...
                                                    <a class="btn btn-outline-default" type="button" href="<?php echo e(route('thickness.index')); ?>">Cancel</a>
                                                </div>
                                            </div>
                                        </div>
...
<?php echo $__env->make('Backend.admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/iweblhrx/public_html/kornizesbadra/resources/views/Backend/admin/thickness/add.blade.php ENDPATH**/ ?>