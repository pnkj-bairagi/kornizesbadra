    ...
    <div class="container-fluid px-0 align-items-stretch">
        ...
        <div class="navbar-header">
            <a href="<?php echo e(route('dashboard')); ?>" class="navbar-brand">
                <img class="logo-expand" alt="" src="<?php echo e(asset('assets/backend')); ?>/img/logo.png" />
                <img class="logo-collapse" alt="" src="<?php echo e(asset('assets/backend')); ?>/img/logo-collapse.png" />
            </a>
        </div>
        <!-- /.navbar-header -->
                            ...
                            <li>
                                <a href="#" class="media">
                                    <span class="d-flex thumb-xs user--online">
                                        <!--<img src="<?php echo e(asset('assets/backend')); ?>/demo/users/user3.jpg" class="rounded-circle" alt="" /> -->
                                    </span>
        ...
        <ul class="nav navbar-nav">
            <li class="dropdown">
                <a href="javascript:void(0);" class="dropdown-toggle dropdown-toggle-user ripple" data-toggle="dropdown">
                    <span class="avatar thumb-xs2"><img src="<?php echo e(asset('assets/backend')); ?>/demo/users/user1.jpg" class="rounded-circle" alt="" /> <i class="material-icons list-icon">expand_more</i></span>
                </a>
                <div class="dropdown-menu dropdown-left dropdown-card dropdown-card-profile animated flipInY">
                    <div class="card">
                        <header class="card-header d-flex mb-0">
                            <a href="<?php echo e(route('profile')); ?>" class="col-md-4 text-center"><i class="list-icon feather feather-feather"></i> </a>
                            <a href="<?php echo e(route('setting')); ?>" class="col-md-4 text-center"><i class="list-icon feather feather-settings"></i> </a>
                            <a href="<?php echo e(route('adminlogout')); ?>" class="col-md-4 text-center"><i class="list-icon feather feather-power"></i></a>
                        </header>
...
<!-- /.navbar --><?php /**PATH /home3/iweblhrx/public_html/kornizesbadra/resources/views/Backend/admin/layout/includes/header.blade.php ENDPATH**/ ?>