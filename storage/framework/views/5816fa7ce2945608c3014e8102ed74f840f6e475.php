...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <link rel="shortcut icon" href="<?php echo e(asset('assets/frontend')); ?>/images/favicons/fie/favicon.ico" />
        ...
        <style>
            @font-face {
                ...
                url('<?php echo e(asset('assets/frontend')); ?>/fonts/montserrat-v15-latin/montserrat-v15-latin-700.woff2') format('woff2');
        ...
        <link rel="stylesheet" href="<?php echo e(asset('assets/frontend')); ?>/css/home.css" media="screen,print" />
    ...
    <body class="home">
            ...
            <div id="js-error" class="page-slice">
                <div class="content-slice">
                    <div class="content-box">
                        ...
                        <a role="button" class="button btn-sky" href="<?php echo e(url('/')); ?>">Try Loading Again</a>
                    </div>
                </div>
            </div>
        </noscript>
        ...
        <?php echo $__env->make('Frontend.layout.includes.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        
        <?php echo $__env->yieldContent('main-content'); ?>
        
        <?php echo $__env->make('Frontend.layout.includes.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <script defer src="<?php echo e(asset('assets/frontend')); ?>/fonts/fontawesome-subset/js/all.min.js"></script>
        <script type="text/javascript" src="<?php echo e(asset('assets/frontend')); ?>/js/site-ui.js"></script>
        <script type="text/javascript">
            var profile_data = {
        ...
        <script type="text/javascript" src="<?php echo e(asset('assets/frontend')); ?>/js/canvas-frame.js"></script>
        <script type="text/javascript" src="<?php echo e(asset('assets/frontend')); ?>/js/upload.js"></script>
        <script type="text/javascript" src="<?php echo e(asset('assets/frontend')); ?>/js/home.js"></script>
        
        <?php echo $__env->yieldPushContent('page-scripts'); ?>
        
    </body>
</html><?php /**PATH /home3/iweblhrx/public_html/kornizesbadra/resources/views/Frontend/layout/app.blade.php ENDPATH**/ ?>