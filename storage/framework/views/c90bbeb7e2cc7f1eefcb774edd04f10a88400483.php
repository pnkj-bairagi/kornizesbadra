                ...
                <div class="widget-chat-activity flex-1">
                    <div class="messages scrollbar-enabled suppress-x">
                        ...
                        <div class="message media">
                            <figure class="thumb-xs2 user--online">
                                <a href="#">
                                    <img src="<?php echo e(asset('assets/backend')); ?>/demo/users/user1.jpg" class="rounded-circle" alt="" />
                                </a>
                            </figure>
                            <div class="message-body media-body">
                        ...
                        <div class="message media reply">
                            <figure class="thumb-xs2 user--offline">
                                <a href="#">
                                    <!--<img src="<?php echo e(asset('assets/backend')); ?>/demo/users/user5.jpg" class="rounded-circle" alt="" />-->
                                </a>
                            </figure>
                            <div class="message-body media-body">
                        ...
                        <div class="message media reply">
                            <figure class="thumb-xs2 user--busy">
                                <a href="#">
                                    <!--<img src="<?php echo e(asset('assets/backend')); ?>/demo/users/user6.jpg" class="rounded-circle" alt="" />-->
                                </a>
                            </figure>
                            <div class="message-body media-body">
...
<?php echo $__env->make('Backend.admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/iweblhrx/public_html/kornizesbadra/resources/views/Backend/admin/dashboard.blade.php ENDPATH**/ ?>