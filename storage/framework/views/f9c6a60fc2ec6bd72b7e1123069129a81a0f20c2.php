                ...
                <div class="row page-title clearfix">
                    <div class="page-title-left">
                        <h6 class="page-title-heading mr-0 mr-r-5">Frame Styles
                         <a type="button" href="<?php echo e(route('style.create')); ?>"  class="btn btn-primary pull-right">Add Style</a>
                        </h6>
                    </div>
                                    ...
                                    <table class="table table-striped" data-toggle="datatables" data-plugin-options='{"searching": false}'>
                                        ...
                                        <?php if($data): ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo e(route('style.edit',$dt->id)); ?>" class="color-content"><i class="material-icons">edit</i></a>
                                                    <a href="<?php echo e(route('style.show',$dt->id)); ?>" class="color-content"><i class="material-icons">delete</i></a>
                                                </td>
                                            </tr>
...
<?php echo $__env->make('Backend.admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/iweblhrx/public_html/kornizesbadra/resources/views/Backend/admin/style/index.blade.php ENDPATH**/ ?>