            ...
            <div class="container-fluid">
                <div class="row page-title clearfix">
                    <div class="page-title-left">
                        <h6 class="page-title-heading mr-0 mr-r-5">Frame Styles</h6>
                    </div>
                </div>
                <!-- /.page-title -->
            </div>
                        ...
                        <div class="col-md-12 widget-holder">
                            <div class="widget-bg">
                                <div class="widget-body clearfix">
                                    ...
                                    <form action="<?php if($data): ?><?php echo e(route('style.update',['style'=>$data->id])); ?><?php else: ?><?php echo e(route('style.store')); ?><?php endif; ?>" method="post" id="Style-Form">
                                        <?php echo csrf_field(); ?>
                                        ...
                                        <div class="form-actions">
                                            <div class="form-group row">
                                                <div class="col-md-9 ml-md-auto btn-list">
                                                    ...
                                                    <a class="btn btn-outline-default" type="button" href="<?php echo e(route('style.index')); ?>">Cancel</a>
                                                </div>
                                            </div>
                                        </div>
...
<?php echo $__env->make('Backend.admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/iweblhrx/public_html/kornizesbadra/resources/views/Backend/admin/style/add.blade.php ENDPATH**/ ?>